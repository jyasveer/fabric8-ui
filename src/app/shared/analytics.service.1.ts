  ...
  private activateLauncherEventListeners(): void {
    this.broadcaster
      ...
      .subscribe((val) => {
        if (val === true) {
          ...
          console.log('add app opened');
        } else {
          // this.analytics.track('add app closed');
          console.log('add app closed');
        }
      });
    this.broadcaster
      ...
      .subscribe((data) => {
        ...
        console.log('click continue app overlay', data);
      });
    this.broadcaster
      .on('showCreateApp')
      .subscribe((val) => {
    ...
    this.broadcaster
      ...
      .subscribe((val) => {
        if (val === true) {
          ...
          console.log('import app opened');
        } else {
          // this.analytics.track('import app closed');
          console.log('import app closed');
        }
      });
    this.broadcaster
    ...
    this.broadcaster
      ...
      .subscribe((id: string) => {
        ...
        //   step: id
        // });
        console.log('step indicator clicked');
      });
  }
